  ...
  <div class="widget search">
    ...
    <form action="<?= theme_escape_html($search_action); ?>" method="get" class="search-form" id="ajax-search-form" role="search" aria-label="<?= t('sidebar.search.title'); ?>">
      <div class="search-input-group">
        ...
        <input type="search" id="search-keyword" name="q" class="search-input" placeholder="<?= t('sidebar.search.placeholder'); ?>" autocomplete="off" autocapitalize="none" spellcheck="false" maxlength="100" role="combobox" aria-autocomplete="list" aria-describedby="search-hint search-results" aria-controls="search-results" aria-expanded="false">
      ...
      <div id="search-results" class="search-results" role="listbox" aria-label="<?= t('sidebar.search.title'); ?>" aria-live="polite" aria-atomic="true"></div>
      <div id="search-error" class="search-error" aria-live="assertive"></div>
      <div class="hp-field" style="display:none" aria-hidden="true"><input type="text" name="search_verify" id="search-verify" autocomplete="off" tabindex="-1" value=""></div>
     </form>
  </div>
