  ...
  switch ($uri->matched) {
    ...
    case 'post':
      ...
      if (!empty($uri->param1)) {
        ...
        $read_post = class_exists('FrontHelper') ? FrontHelper::grabPreparedFrontPostById($uri->param1) : ""; 
    ...
    case 'page':
      ...
      $theme_meta['site_meta_tags'] = is_null($page_id) ? generate_meta_tags(ucfirst(trim('page not found')) . ' | ' . escape_html(app_info()['site_ame'])) : generate_meta_tags($page_title, $description, $author, $image, $canonical);
