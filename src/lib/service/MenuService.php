...
class MenuService
{
     ...
     * setMenuLocale
     *
     * @param string $menu_locale
     *
     */
    public function setMenuLocale($menu_locale)
    {
        $this->menu_locale = sanitize_locale($menu_locale);
    }
    ...
    {
        return $this->menuDao->dropDownLocale($selected);
    }
