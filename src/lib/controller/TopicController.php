...
class TopicController extends BaseApp
{
    ...
    public function insert()
    {
        ...
        if (isset($_POST['topicFormSubmit'])) {
            $filters = [
              'topic_title' => isset($_POST['topic_title']) ? Sanitize::severeSanitizer($_POST['topic_title']) : "",
              'topic_locale' => isset($_POST['topic_locale']) ? Sanitize::mildSanitizer($_POST['topic_locale']) : "en"
            ];
            ...
            try {
                ...
                if (!$checkError) {
                    ...
                    $this->topicService->setTopicLocale(distill_post_request($filters)['topic_locale']);
