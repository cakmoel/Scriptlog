 ...
 *
 * @category  Class CommentController extends BaseApp
...
class CommentController extends BaseApp
{
    ...
    public function update($id)
    {
        ...
        $data_comment = array(
            ...
            'post_title' => $getComment['post_title']
        ...
        if (isset($_POST['commentFormSubmit'])) {
            ...
            try {
                ...
                if (!$checkError) {
                    ...
                    $this->view->set('commentStatus', $this->commentService->commentStatementDropDown($getComment['comment_status']));
                    $this->view->set('csrfToken', csrf_generate_token('csrfToken'));
                } else {
                    $this->commentService->setCommentId($comment_id);
                    $this->commentService->setCommentContent($comment_content);
                    $this->commentService->setCommentStatus($comment_status);
                    $this->commentService->setAuthorName($author_name);
