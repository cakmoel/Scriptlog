...
if (function_exists('is_permalink_enabled') && is_permalink_enabled() === 'yes') :
    ?>
<i>ex: /post/id/your-friendly-neighborhood</i>.Please check out <a href="https://developers.scriptlog.my.id/" target="_blank" rel="noopener noreferrer">documentation</a> for more information.
<?php else :
    ?>
<i>ex: ?p=1</i>. Please check out <a href="https://developers.scriptlog.my.id/" target="_blank" rel="noopener noreferrer">documentation</a> for more information.
      <?php
endif;
?>
</p>
...
<input type="number" class="form-control" name="menu_sort" id="menu_sort" min="0" data-abs value="<?php
$menuSort = '';
if (isset($menuData)) {
