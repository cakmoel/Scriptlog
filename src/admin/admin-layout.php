...
<head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
        href="<?= $stylePath; ?>/assets/components/datatables.net-bs/css/dataTables.bootstrap.min.css">
    ...
    <link rel="icon" type="image/png" sizes="192x192"
        href="<?= $stylePath; ?>/assets/dist/img/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="144x144"
        href="<?= $stylePath; ?>/assets/dist/img/android-icon-144x144.png">
    ...
    ?>
        ...
        ?>
            ...
            <strong>Thank you for creating with
                <a href="https://scriptlog.my.id" target="_blank" rel="noopener noreferrer"
                    title="PHP Blog Software">Scriptlog</a>
    ...
    $(document).ready(function() {
        $('#summernote').summernote({
            ...
            fontNames: [
                ...
                'Times New Roman', 'DejaVu Serif', 'Noto Serif'
            ],
