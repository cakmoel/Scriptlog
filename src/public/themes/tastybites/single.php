...
$post_id = isset($retrieve_post['ID']) ? (int)$retrieve_post['ID'] : 0;
...
$categories = retrieves_topic_simple($post_id);
$tags = link_tag($post_id);
?>
            ...
            <div class="post-single">
                ...
                <div class="post-details">
                    <div class="post-meta d-flex justify-content-between">
                        <div class="category">
                            <?= isset($post_id) ? $categories : ""; ?>
                        </div>
                    </div>
                    <h1><?= isset($post_title) ? $post_title : ""; ?></h1>
