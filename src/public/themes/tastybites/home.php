...
$hero_post = null;
$hero_headline_exists = false;

if (function_exists('featured_post')) :
    $hero_headline_exists = true;
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <h2 class="h3"><?= isset($sticky_title) ? $sticky_title : "Welcome to Tasty Bites"; ?></h2>
                <p class="text-big">
                   <?= isset($sticky_content) ? $sticky_content : "Your tasty bites blog lets you easily express, create, and share your ideas."; ?>
                </p>
