            ...
            <div class="col-12">
                <ul class="footer-nav list-inline text-center mb-4">
                    ...
                    <li class="list-inline-item">
                        <a href="<?= htmlout($item['menu_link'] ?? '#'); ?>" class="footer-nav-link"><?= htmlout($item['menu_label'] ?? ''); ?></a>
                    </li>
                    <?php endforeach; ?>
                </ul>
            </div>
...
<script src="<?= theme_dir(); ?>assets/vendor/bootstrap/js/popper.min.js" defer></script>
