...
$retrieve_comments = retrieve_comments($post_id, $cpage);
            ...
            <div class="post-details">
              ...
              ?>
                ...
                <div class="post-comments">
                  <header>
                    <h3 class="h6 mb-4">Post Comments<span class="no-of-comments">(<?= $total_comment; ?>)</span></h3>
                  </header>

                  <?= display_comments($retrieve_comments, $cpage, $total_comment); ?>
