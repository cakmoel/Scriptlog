    ...
    <main class="post blog-post col-lg-8">
      <div class="container">
        <div class="post-single">
          <div class="post-thumbnail"><img src="<?= isset($post_img) ? invoke_webp_image($post_img) : "https://picsum.photos/730/486"; ?>" alt="<?= ($img_alt) ? $img_alt : $post_title; ?>" class="img-fluid"></div>
