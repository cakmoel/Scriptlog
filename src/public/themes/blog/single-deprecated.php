...
$total_comment = (total_comment($post_id) > 0) ? total_comment($post_id)['total'] : 0;
        ...
        <div class="post-single">
          ...
          <div class="post-details">
            ...
            ?>
              ...
              <?php
                if (function_exists('fetch_comments')) :
                 $commentsByPost = is_array(fetch_comments($post_id)['comments']) ? fetch_comments($post_id)['comments'] : "";
                 foreach ($commentsByPost as $comment) :

                  $comment_id = isset($comment['ID']) ? intval((int)$comment['ID']) : "";
