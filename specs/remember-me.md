...
| Enter password | `4dMin(*)^` | Password masked |
...
| Action | Input | Expected Behaviour |
|--------|-------|-------------------|
| Enter credentials | `administrator` / `4dMin(*)^` | |
...
| E05 | Remember Me with special-char password | Boundary | Password `4dMin(*)^` | Unaffected (bcrypt) |
