...
function get_table_definitions($prefix = '')
{
  ...
  KEY idx_topic_locale(topic_locale)
  )Engine=InnoDB DEFAULT CHARSET=utf8mb4";
  ...
  KEY id_comment_post(comment_post_id)
   ...
   PRIMARY KEY (ID),
   KEY idx_menu_locale(menu_locale)
  )Engine=InnoDB DEFAULT CHARSET=utf8mb4";
  ...
  PRIMARY KEY(ID),
  KEY theme_directory(theme_directory),
  ...
  KEY log_date(log_date)
    ...
    $tblThemeLicenses = "CREATE TABLE IF NOT EXISTS {$prefix}tbl_theme_licenses (
  ID BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY lang_code (lang_code)
    ...
    $alterMenuLocale = "ALTER TABLE {$prefix}tbl_menu ADD COLUMN menu_locale VARCHAR(10) NOT NULL DEFAULT 'en' AFTER menu_sort, ADD INDEX idx_menu_locale (menu_locale)";
    ...
    return [
      ...
      'tblThemeLicenses' => $tblThemeLicenses,
