...
class AdditionalUtilityFunctionsTest extends TestCase
{
    ...
    public function testValidateDateVariations(): void
    {
        if (function_exists('validate_date')) {
            ...
            $this->assertTrue(validate_date('2023-05-15 14:30:00', 'Y-m-d H:i:s'));
            $this->assertTrue(validate_date('2023-05-15 14:30:00', 'Y-m-d'));
            $this->assertFalse(validate_date('2023-05-15 14:30:00 99', 'Y-m-d H:i:s'));
            $this->assertFalse(validate_date('2023-02-30 14:30:00', 'Y-m-d H:i:s'));
        }
    }
